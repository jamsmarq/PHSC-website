...
const Questions = () => {
  ...
  return (
    <div className="max-w-screen-xl px-4 md:px-6 xl:px-8 mx-auto mt-32 space-y-12 relative scroll-mt-10" id="faqs">
      ...
      <DivFadeIn className="mx-auto w-[60rem] border-[0.15rem] border-eerie-black rounded-3xl overflow-hidden bg-[#FEFFFE]">
