  ...
  return (
    <>
      <div className="w-full h-fit bg-cover about-background pt-64 pb-48" id="about">
        <DivFades type="fadeInUp" className="mx-auto w-fit h-fit flex items-center space-x-10 max-w-screen-xl px-4 md:px-6 xl:px-8">
      ...
      <div className="relative -top-20 space-y-48 max-w-screen-xl px-4 md:px-6 xl:px-20 mx-auto">
        <DivFades type="fadeInUp" className="flex justify-between items-center relative space-x-10">
          <div className="flex">
        ...
        <DivFades type="fadeInUp" className="flex justify-between items-center relative -top-20 space-x-10">
            ...
            <div className="flex flex-col space-y-8">
              ...
              <div className="space-y-6">
                <div className="h-fit space-x-8 flex items-center">
                  ...
                  <div className="space-y-4 h-fit">
                    <div className="flex flex-col gap-y-2">
                      <img src="icons/discord-logo.png" width="35" height="35" className="" />
                ...
                <div className="h-fit space-x-8 flex items-center">
                  ...
                  <div className="space-y-4 h-fit">
                    <div className="flex flex-col gap-y-2">
                      <img src="icons/facebook-logo.png" width="35" height="35" className="" />
