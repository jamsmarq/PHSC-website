...
const Features = () => {
  return (
    <div className="max-w-screen-xl px-4 md:px-6 xl:px-8 mx-auto mt-32 space-y-12">
      ...
      <div className="grid md:grid-cols-3 sm:grid-cols-2  grid-cols-1 gap-20 w-fit mx-auto">
        <div className="w-fit h-fit space-y-3 col-span-1 flex flex-col items-center">
          <img src="features-first.png" width="200" height="200" className="" />
          <p className="text-xl font-bold w-[18rem]">Develop Practical Skills Through FREE Online Events</p>
        </div>
        <div className="w-fit h-fit space-y-3 col-span-1 flex flex-col items-center">
          <img src="features-second.png" width="200" height="200" className="" />
          <p className="text-xl font-bold w-[18rem]">Win Some Prizes With Open Challenges And Giveaways</p>
        </div>
        <div className="w-fit h-fit space-y-3 col-span-1 flex flex-col items-center">
          <img src="features-third.png" width="200" height="200" className="" />
          <p className="text-xl font-bold w-[18.5rem]">Make Connections And Create A Network With Other Students</p>
        </div>
        <div className="w-fit h-fit space-y-3 col-span-1 flex flex-col items-center">
          <img src="features-fourth.png" width="200" height="200" className="" />
          <p className="text-xl font-bold w-[18.5rem]">Get Academic And Professional Resources And Opportunities</p>
        </div>
         <div className="w-fit h-fit space-y-3 col-span-1 flex flex-col items-center">
          <img src="features-fifth.png" width="200" height="200" className="" />
          <p className="text-xl font-bold w-[18.5rem]">Participate On Activities And Make A Positive Impact</p>
        </div>
         <div className="w-fit h-fit space-y-3 col-span-1 flex flex-col items-center">
          <img src="features-third.png" width="200" height="200" className="" />
          <p className="text-xl font-bold w-[18.5rem]">Make Connections And Create A Network With Other Students</p>
