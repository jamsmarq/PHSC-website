...
const Tracks = () => {
  return (
    <div className="max-w-screen-xl px-4 md:px-6 xl:px-20 mx-auto mt-32 space-y-12 scroll-mt-10" id="tracks">
      ...
      <div className="grid md:grid-cols-3 sm:grid-cols-2  grid-cols-1 gap-8 w-full mx-auto relative">
        <div className="w-full h-fit space-y-3 p-5 col-span-1 rounded-2xl border-[0.15rem] border-eerie-black bg-[#FFEFEF]">
        ...
        <div className="w-full h-fit space-y-3 p-5 col-span-1 rounded-2xl border-[0.15rem] border-eerie-black bg-[#EFFFF3]">
        ...
        <div className="w-full h-fit space-y-3 p-5 col-span-1 rounded-2xl border-[0.15rem] border-eerie-black bg-[#EFF6FF]">
        ...
        <div className="w-full h-fit space-y-3 p-5 col-span-1 rounded-2xl border-[0.15rem] border-eerie-black bg-[#FBEFFF]">
        ...
        <div className="w-full h-fit space-y-3 p-5 col-span-1 rounded-2xl border-[0.15rem] border-eerie-black bg-[#FEFFEF]">
        ...
        <div className="w-full h-fit space-y-3 p-5 col-span-1 rounded-2xl border-[0.15rem] border-eerie-black bg-[#FFEFF5]">
        ...
        <div className="w-full h-fit space-y-3 p-5 col-span-1 rounded-2xl border-[0.15rem] border-eerie-black bg-[#EFFFFE]">
          <img src="tracks-seventh.png" width="45" height="45" className="" />
          <p className="text-xl font-bold">Business and Finance</p>
          <p className="font-medium text-davy-gray w-[19rem]">Essential financial literacy, budgeting, and entrepreneurial skills for personal and professional success.</p>
        </div>
        <div className="w-full h-fit space-y-3 p-5 col-span-1 rounded-2xl border-[0.15rem] border-eerie-black bg-[#EFF0FF]">
          <img src="tracks-eight.png" width="45" height="45" className="" />
          <p className="text-xl font-bold">Business and Finance</p>
          <p className="font-medium text-davy-gray w-[19rem]">Essential financial literacy, budgeting, and entrepreneurial skills for personal and professional success.</p>
        </div>
        <div className="w-full h-fit space-y-3 p-5 col-span-1 rounded-2xl border-[0.15rem] border-eerie-black bg-[#FFFAEF]">
