...
const Hero = () => {
  ...
  return (
    <div className="w-full h-fit relative mx-auto bg-gradient-to-br from-[#E7EFFB] to-[#FBF2E7] pt-10 md:pt-20">
      <DivFadeIn className="max-w-screen-xl px-4 md:px-6 xl:px-8 py-4 mx-auto flex flex-col justify-center space-y-10">
        <h1 className="md:w-[40rem] leading-tight text-center lg:w-fit text-6xl xs:text-6xl sm:text-6xl md:text-7xl font-black mx-auto bg-gradient-to-r from-[#0737A4] to-[#BC1532] bg-clip-text text-transparent py-3">Philippine Student Community</h1>
        <p className="text-lg md:text-xl md:w-[40rem] mx-auto text-center text-davy-gray font-medium">A community for Filipino learners and educators to foster <span className="text-eerie-black"> transferrable and life-long skills </span> that are not usually taught in traditional classrooms.</p>
        <div className="mx-auto w-full md:w-fit h-fit space-x-4 flex flex-col md:flex-row">
          ...
          <button className={`relative flex items-center mx-auto md:mx-0 w-[14.7rem] gap-x-3 rounded-full bg-red-600 px-6 py-3 font-bold text-white bg-gradient-to-r from-[#0737A4] to-[#BC1532] text-xl`} onMouseEnter={() => setCtaHover(true)} onMouseLeave={() => setCtaHover(false)}>
      ...
      {/* Stats Data */}
      <DivFadeIn className="relative top-20 flex justify-between items-center rounded-full border-2 py-8 px-28 w-fit mx-auto max-w-screen-2xl gap-x-16 border-eerie-black bg-white bg-opacity-40 backdrop-blur-md">
